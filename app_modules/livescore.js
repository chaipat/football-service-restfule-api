...
livescoreModule.getTopChart = function(req, res, next) {
  ...
  if( isNaN(tournamentId)) {
    ...
    var cacheKey = cacheKeyPrefix + 'category-livescore-' + topchart + '-'
      + tournamentId;
  }
                  ...
                  if (utils.isEmptyObject(result)) {
                    ...
                    callback(error);
                      ...
                      async.each(players, function(item, cb) {
                        ...
                        pg.result, pg.kickoff, pg.status as match_status \
...
livescoreModule.getProgram = function(req, res, next) {
  ...
  if( isNaN(tournamentId) ) {
    ...
    var cacheKey = cacheKeyPrefix + 'category-livescore-programs-'
      + tournamentId + kickoffDayCacheKey;
  }
          ...
          async.series([
            ...
            function (callback) { // Get previous match compettition
              ...
              async.each(previousMatch, function(item, cb) {
                ...
                p.status as match_status, p.program_status as remark_status, \
                p.result, p.channel1, p.channel2, \
...
livescoreModule.getMonthlyPrograms = function(req, res, next) {
  ...
  var cacheKey = cacheKeyPrefix + 'category-livescore-monthlyPrograms-'
    + tournamentId + '-' + paramYear + '-' + paramMonth;
...
livescoreModule.getYearPrograms = function(req, res, next) {
  ...
  var cacheKey = cacheKeyPrefix + 'category-livescore-yearPrograms-'
    + tournamentId + '-' + paramYear;
...
livescoreModule.getProgramByTeam = function(req, res, next) {
  ...
  if( isNaN(teamId) ) {
    ...
    var cacheKey = cacheKeyPrefix + 'category-livescore-programs-byteam-'
      + teamId + kickoffDayCacheKey;
  }
...
livescoreModule.getMonthlyProgramsByTeam = function(req, res, next) {
  ...
  var cacheKey = cacheKeyPrefix + 'category-livescore-monthlyPrograms-byteam-'
    + teamId + '-' + paramYear + '-' + paramMonth;
...
livescoreModule.getYearProgramsByTeam = function(req, res, next) {
  ...
  var cacheKey = cacheKeyPrefix + 'category-livescore-yearPrograms-byteam-'
    + teamId + '-' + paramYear;
